...
import InfiniteBackground from './Games/InfiniteBackground.js';
export default class Experiments extends React.Component {
	...
	render () {
		...
		if(this.state.activeGame === '') {
			...
			game.push(<InfiniteBackground loader_data={this.loader_data} key={this.state.activeGame} />)
		...
		} else if (this.state.activeGame === '15') {
