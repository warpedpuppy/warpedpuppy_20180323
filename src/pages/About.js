    ...
    return (
    	<div>
	      ...
	      <svg x="0px" y="0px" viewBox="0 0 559 368">
	          <g id="end">
	            <path  ref={item => this.path1 = item} class="st0" d="M67.7,133.1c-11.7,11.9-60.7,64-48,117c16.1,67.4,119.9,85.4,169,94c42.9,7.5,98.2,17.1,157-13
	          ...
	          <g id="start">
	            <path  ref={item => this.path2 = item} class="st1" d="M229.2,52.7c171.4-11.1,240.4-31.1,257.7,1.2c10.5,19.6-11.8,32.5-5.8,71.1c9.2,59.3,68.4,70.6,67.6,106.1
