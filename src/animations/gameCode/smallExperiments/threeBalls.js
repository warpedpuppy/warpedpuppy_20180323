export default function TwoBalls (PIXI, Utils){
    return {
        ...
        build: function () {
            ...
            this.b2 = this.ball2.getBody();
            this.b2.x = Math.random() * this.canvasWidth;
            this.b2.y = Math.random() * this.canvasHeight;
        ...
        animate: function () {
            ...
            .lineTo(this.b2.x, this.b2.y)
            .lineTo(this.b0.x, this.b0.y)
            ...
            } else if (this.ball2Dragging) {
                this.b2.x = this.mousePosition.x;
                this.b2.y = this.mousePosition.y;
            }

            if (!this.ball0Dragging) {
                this.springTo(this.ball0, this.ball1);
                this.springTo(this.ball0, this.ball2);
            } 
            if(!this.ball1Dragging) {
                this.springTo(this.ball1, this.ball0);
                this.springTo(this.ball1, this.ball2);
            }
            if(!this.ball2Dragging)
            {
                this.springTo(this.ball2, this.ball0);
                this.springTo(this.ball2, this.ball1);
            }


            this.keepOnStage(this.b0);
            this.keepOnStage(this.b1);
            this.keepOnStage(this.b2);
